{
  description = "Brute agent — multi-agent configuration (reader + coder)";
      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "Brute multi-agent ready. Run: bundle exec async-service service.rb"
            echo "  reader on :9292, coder on :9293"
          '';
        };

        packages.default = pkgs.stdenv.mkDerivation {
          pname = "brute-multi-agent";
          version = "0.1.0";
          src = ./.;
